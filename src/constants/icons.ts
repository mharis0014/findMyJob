...
const ICONS = {
  ...
  search_user: require('../assets/icons/search-user.png'),
  addition: require('../assets/icons/addition.png'),
  home_light: require('../assets/icons/home-light.png'),
  home_dark: require('../assets/icons/home-dark.png'),
  chat_light: require('../assets/icons/chat-light.png'),
